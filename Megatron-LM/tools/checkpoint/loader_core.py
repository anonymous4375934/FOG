    ...
    for vp_rank in range(vp_size):
        ...
        for pp_rank in range(pp_size):
            ...
            for layer_num in range(schema.get_num_layers(models[0])):
                ...
                if layer.get("self_attn_q_dyt_alpha") is not None:
                    message["q dyt alpha"] = layer["self_attn_q_dyt_alpha"]
                if layer.get("self_attn_k_dyt_alpha") is not None:
                    message["k dyt alpha"] = layer["self_attn_k_dyt_alpha"]
