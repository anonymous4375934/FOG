...
def _add_network_size_args(parser):
    ...
    group.add_argument("--mlp-alpha", default=None, type=float,
                       help="Scalar alpha applied to the inputs of MLPs")
    group.add_argument("--scaled-swiglu", action="store_true",
                       help="When used in conjunction of `--swiglu`, uses ScaledSwiGLU a.k.a. SoothSwiGLU scaling.")
    return parser
