"""
python3 scripts/tools/create_data_mixture.py --folders path/to/tokenized/fineweb2 path/to/tokenized/fineweb-edu --weights 0.1 0.9 --output datasets/mixtures/my-first-data-mixture
"""
