"""
python3 scripts/tokenization/prepare_dumps.py --dataset-folder path/to/tokenized/fineweb2 --filter-in snapshot/data train --filter-out _removed und_ --preprocessing-metadata-folder datasets/fineweb-2 --n-dumps 10
"""
